...
const MonoApiHelper = {
  ...
  ClassGetName: mono_class => {
    return MonoApi.mono_class_get_name(mono_class).readUtf8String()
  },
  ...
  StringToUtf8: mono_string => MonoApi.mono_string_to_utf8(mono_string).readUtf8String(),
  TypeGetClass: MonoApi.mono_type_get_class,
  TypeGetName: mono_type => MonoApi.mono_type_get_name(mono_type).readUtf8String(),
